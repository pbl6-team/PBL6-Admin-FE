...
export default function ToolBar({setLoadData, setData, search, setSearch, setIsSearch, setPage, setTotalPages, status, setStatus }) {
    ...
    <div className="flex justify-between px-4 py-2 items-center">
      ...
      <Select onValueChange={val => fetchDataByStatus(val)}>
        ...
        <SelectContent>
          ...
          <SelectItem value="2">Lock</SelectItem>
          <SelectItem value="1">Unlock</SelectItem>
        </SelectContent>
      </Select>
